...
#define	RTT_RXTMIN     1000	/* min retransmit timeout value, seconds */
#define	RTT_RXTMAX     3000	/* max retransmit timeout value, seconds */
...
int	 rtt_timeout(struct rtt_info *,int);
